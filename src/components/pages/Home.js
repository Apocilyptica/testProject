    ...
    <div className="home-main-container">
      <div className="container">
        ...
        <p>
          ...
          non. Ullamco ullamco est et amet non do incididunt nulla elit laborum. Nostrud officia minim Lorem consequat ad consectetur culpa eu. Tempor
          nulla nulla est elit non nostrud nulla.
        </p>
        <h3 className="text-uppercase text-center py-3">Built using React-Bootstrap and Bootstrap 4</h3>
      </div>
    </div>
  );
};
